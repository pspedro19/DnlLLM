...
class SalesAgent:
    def __init__(self, model_path, openai_api_key, memory_file="memory.json", max_execution_time=10):
        ...
        # Define a prompt template for enhancing interactions
        self.prompt_template = PromptTemplate(
            template="You are a sales agent. Use past interactions and this context to enhance customer satisfaction: {input}."
        )

        # Set the maximum time allowed for generating responses
        self.max_execution_time = max_execution_time

        # Setup the language model chains for interaction
    ...
    async def handle_query(self, user_input):
        # Retrieve relevant memory context to enhance the input
        ...
        # Generate responses from both HF model and OpenAI model
        ...
        # Select the shorter response for simplicity
...
if __name__ == "__main__":
    # Set the path to the checkpoint directory containing the fine-tuned model
    fine_tuned_model_path = "/DnlLLM/src/results/20240412_211227/checkpoint-200"
